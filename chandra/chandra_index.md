...
This is a work in progress. A kalā may be added every month or so.
</div>

<ul>
 <li><a href="{% link chandra/introduction.md %}">preamble / introduction to the saṁskr̥ta vicāra candrodaya</a></li>
 <li><a href="{% link essays/big_picture.md %}">the big picture & sādhanas</a></li>
</ul>
...
{% for kala_item in site.kala %}
    {% if kala_item.sections or kala_item.skip_publish != true %}
