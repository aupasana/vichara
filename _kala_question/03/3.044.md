...
Each bhūta is divided into two equal parts, and one half of each is kept aside. The other half is divided into four equal parts. Each of the four parts is joined with a half differenct from itself.