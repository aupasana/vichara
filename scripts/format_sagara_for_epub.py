...
# Load HTML
with open('_site/sagara/publish/raw.html', 'r', encoding='utf-8') as f:
...
# Save output
with open('_site/sagara/publish/raw2.html', 'w', encoding='utf-8') as f:
    f.write(soup.decode())

HTML("_site/sagara/publish/raw2.html").write_pdf("_site/sagara/publish/sagara.pdf")